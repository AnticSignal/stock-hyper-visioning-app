...
module.exports = async function (context, req) {
    ...
    context.log("inquire-time-itemconclusion function started");
    ...
    const apiUrl = `${process.env.HTS_SIMU_DOMAIN}/uapi/domestic-stock/v1/quotations/inquire-time-itemconclusion?` +
